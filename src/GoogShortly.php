 ...
 * @package zhilevan
 * @version 0.2
 * @author zhilevan <mail@zhilevan.ru>
 * @link   http://www.zhilevan.ru/
 * @link https://github.com/zhilevan/Googl
...
class GoogShortly
{
     ...
     * @return string
     * @throws GoogShortlyException
     */
    public function shorten($link)
    {
        if (!$this->checkLink($link)) {
            throw new GoogShortlyException('Incorrect URL format');
        }
    ...
    private function sendRequest($params)
    {
        ...
        if (!$result = curl_exec($ch)) {
            ...
            throw new GoogShortlyException($error, $errno);
        }
        ...
        if (isset($result['error'])) {
            throw new GoogShortlyException($result['error']['message'], $result['error']['code']);
        }
...
/**
 * Class GoogShortlyException
 *
 * @package zhilevan
 */
class GoogShortlyException extends \Exception
{
